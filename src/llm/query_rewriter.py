...
class QueryRewriterService:
    ...
    def __init__(self, model: str = None):
        ...
        self.system_prompt = (
            ...
            "7. Para pedidos de quiz, testes ou perguntas de revisão, garanta que a intenção de ser 'testado' ou fazer um 'quiz' esteja clara na reescrita.\n\n"
            "EXEMPLOS:\n"
            "Usuário: 'oq tem pra hoje?'\n"
            "Rewriter: 'quais são as aulas, tarefas e provas agendadas para hoje?'\n\n"
            "Usuário: 'me faça um quiz de redes'\n"
            "Rewriter: 'iniciar um quiz com perguntas de revisão sobre redes de computadores'\n\n"
